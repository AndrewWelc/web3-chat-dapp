...
function LoggedHeader() {
    ...
    return (
        <div className="text-custom-gradient sticky top-0 p-6 z-50 header-bg-glassmorphism shadow-sm border-green-700 border-b-2">
            <div className="grid grid-cols-5 lg:grid-cols-6 items-end lg:items-center">
                <div className="relative w-24 h-24 mx-auto hidden lg:inline-grid border-green-500 lg:border-4 border-2  rounded-full">
